...
import { Sparkles, AlertCircle, CheckCircle, Eye, EyeOff, ArrowRight } from 'lucide-react';
...
export default function ResetPassword() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-[#030712] selection:bg-pink-500/30">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-panel rounded-[2.5rem] px-10 py-12 border border-white/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="mb-10">
              ...
              <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-gray-400 tracking-tight">Set new password</h1>
              <p className="text-gray-400 mt-2 font-medium text-sm">Enter your new access phrase below</p>
            </div>
            ...
            {success ? (
              <div className="text-center py-4">
                ...
                <p className="text-gray-400 text-sm mb-2">Redirecting you to sign in...</p>
                <Link to="/login" className="text-pink-400 hover:text-pink-300 font-semibold text-sm transition-colors">
                  Go to sign in
                </Link>
              </div>
            ) : (
              <>
                {error && (
                  <div className="mb-6 flex items-center gap-3 p-4 bg-red-500/10 border border-red-500/30 rounded-2xl text-red-200 text-sm backdrop-blur-md">
