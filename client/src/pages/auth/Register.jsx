        ...
        <div className="glass-panel rounded-[2.5rem] px-10 py-12 border border-white/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="mb-10">
              ...
              <p className="text-gray-400 mt-2 font-medium text-sm">Complete your registration to get started</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest pl-1">Email</label>
                <input
                  type="email"
                  value={email}
                  readOnly={!!invite?.email}
                  className="w-full px-5 py-4 bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl text-white font-medium text-base shadow-inner opacity-70 cursor-not-allowed"
                />
              </div>
