...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 sm:p-12 relative overflow-hidden bg-background selection:bg-pink-500/30 font-sans">
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
        ...
        <div className="lg:col-span-5 bg-card text-card-foreground border rounded-xl shadow-sm rounded-[2.5rem] px-10 py-12 sm:px-14 sm:py-16 border border-border flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="mb-12">
              <div className="inline-flex items-center justify-center p-3.5 bg-gradient-to-tr from-purple-500 to-pink-500 rounded-2xl mb-8 shadow-[0_0_30px_rgba(236,72,153,0.4)] border border-pink-400/50">
                <Sparkles className="h-8 w-8 text-white font-bold" />
              </div>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-foreground via-foreground/90 to-foreground/70 tracking-tight leading-tight">Diviner<br/>Media</h1>
              <p className="text-primary mt-3 font-bold text-sm tracking-[0.2em] uppercase">Intern Training Portal</p>
            </div>

            {error && (
              <div className="mb-8 flex items-center gap-3 p-4 bg-red-500/10 border border-red-500/30 rounded-2xl text-destructive text-sm backdrop-blur-md shadow-inner">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="block text-xs font-bold text-muted-foreground uppercase tracking-widest pl-1">Intern Email</label>
                <input
                  type="email"
                  value={email}
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center pl-1 pr-2">
                  <label className="block text-xs font-bold text-muted-foreground uppercase tracking-widest">Security Keyword</label>
        ...
        <div className="hidden lg:grid col-span-7 grid-cols-2 grid-rows-3 gap-8 h-full">
          ...
          <div className="col-span-2 row-span-2 bg-card text-card-foreground border rounded-xl shadow-sm rounded-[2.5rem] px-12 py-14 relative overflow-hidden group hover:border-white/30 transition-all duration-700 flex flex-col justify-end">
            ...
            <div className="absolute -right-12 -top-24 opacity-10 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-1000 ease-out">
              <Layers className="w-[36rem] h-[36rem] text-foreground font-semibold" />
            </div>
            
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-muted/80 border border-border text-xs font-bold text-primary mb-8 backdrop-blur-md uppercase tracking-[0.15em] shadow-lg">
              ...
              <h2 className="text-5xl font-black text-foreground font-semibold leading-[1.1] tracking-tight">
                Master the Art of <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-blue-500 to-cyan-500">Viral Content Creation</span>
              </h2>
              <p className="text-muted-foreground mt-6 max-w-lg text-lg font-medium leading-relaxed">
          ...
          <div className="col-span-1 row-span-1 bg-card text-card-foreground border rounded-xl shadow-sm rounded-[2.5rem] px-10 py-8 relative overflow-hidden group hover:bg-muted/80 transition-colors duration-500 flex flex-col justify-center">
            ...
            <h3 className="text-2xl font-bold text-foreground font-semibold relative z-10 tracking-tight">Growth Analytics</h3>
            <p className="text-muted-foreground text-sm mt-3 relative z-10 font-medium leading-relaxed">Decode algorithms, optimize viewer retention, and scale client accounts dynamically.</p>
          </div>
          ...
          <div className="col-span-1 row-span-1 bg-card text-card-foreground border rounded-xl shadow-sm rounded-[2.5rem] px-10 py-8 relative overflow-hidden group hover:bg-muted/80 transition-colors duration-500 flex flex-col justify-center">
            ...
            <h3 className="text-2xl font-bold text-foreground font-semibold relative z-10 tracking-tight">Post-Production</h3>
            <p className="text-muted-foreground text-sm mt-3 relative z-10 font-medium leading-relaxed">Master editing flow-states, visual micro-hooks, and high-impact pacing techniques.</p>
          </div>
