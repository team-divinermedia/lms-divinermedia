        ...
        <div className="glass-panel rounded-[2.5rem] px-10 py-12 border border-white/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="mb-10">
              ...
              <p className="text-gray-400 mt-2 font-medium text-sm">We'll send a reset link to your email</p>
            </div>
            ...
            {success ? (
              ...
              <>
                ...
                <div className="mt-8 text-center">
                  <Link to="/login" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-white transition-colors font-medium">
                    <ArrowLeft className="h-4 w-4" />
                    Back to sign in
                  </Link>
                </div>
