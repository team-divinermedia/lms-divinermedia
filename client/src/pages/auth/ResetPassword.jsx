        ...
        <div className="bg-card text-card-foreground border rounded-xl shadow-sm rounded-[2.5rem] px-10 py-12 border border-border relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="mb-10">
              ...
              <p className="text-muted-foreground mt-2 font-medium text-sm">Enter your new access phrase below</p>
            </div>
            ...
            {success ? (
              <div className="text-center py-4">
                ...
                <h2 className="text-xl font-bold text-foreground font-semibold mb-3">Password reset!</h2>
                <p className="text-muted-foreground text-sm mb-2">Redirecting you to sign in...</p>
                <Link to="/login" className="text-pink-400 hover:text-primary font-semibold text-sm transition-colors">
                  Go to sign in
                </Link>
              </div>
            ) : (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="space-y-2">
                    <label className="block text-xs font-bold text-muted-foreground uppercase tracking-widest pl-1">New Password</label>
                  ...
                  <div className="space-y-2">
                    <label className="block text-xs font-bold text-muted-foreground uppercase tracking-widest pl-1">Confirm Password</label>
                    <input
                      type="password"
